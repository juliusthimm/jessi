...
const Index = () => {
  ...
  return <div className="min-h-screen bg-pulse-800 text-pulse-100">
      <div className="container max-w-5xl mx-auto px-4 py-12">
        {stage === "welcome" && <div className="text-center space-y-8 animate-fadeIn">
        ...
        {stage === "assessment" && <div className="animate-fadeIn">
            <ChatInterface onComplete={() => setStage("report")} />
          </div>}

        {stage === "report" && <div className="space-y-8 animate-fadeIn">
