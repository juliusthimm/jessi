...
const Home = () => {
  ...
  const renderDashboard = () => {
    const commonElements = <div className="grid grid-cols-[1fr,300px] gap-6">
        <div className="flex flex-col gap-6">
          ...
          {/* HR Actions */}
          {userRole === 'hr' && <div className="w-full">
              <Card className="p-6 bg-white/5 backdrop-blur-lg border-white/10">
        ...
        <div className="space-y-6">
          {!showAssessment && userRole === 'admin' && <Card className="p-6 bg-white/5 backdrop-blur-lg border-white/10">
              <div className="flex items-center gap-4">
                <div className="p-3 rounded-full bg-pulse-700/50">
                  <BarChart2 className="h-6 w-6 text-pulse-300" />
                </div>
                <div>
                  <h2 className="text-xl font-semibold text-pulse-100">Company Chats</h2>
